...
# The curve selection(n, p, g, a, b) is the same as Openssl, pls see Openssl ver1.1.1f.
# The default user id used in sign_with_sm3 as specified in GM/T 0009-2012 */
# is "1234567812345678", which is the same as NDNCXX.
# -----------------------------------------------------------------------------
...
#n is order
#p is the prime, determine the value field of a point(x, y).
#g is the generator point.
#a is EC equation parameter a
#b is EC equation parameter b 
