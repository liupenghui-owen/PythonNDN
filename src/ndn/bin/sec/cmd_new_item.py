...
#added by liupenghui, add SM2 support choices=['e', 'r', 's'].
def add_parser(subparsers):
    parser = subparsers.add_parser('New-Item', aliases=['key-gen', 'ni', 'new-item'])
    parser.add_argument('-t', '--type', metavar='TYPE', default='e', choices=['e', 'r', 's'],
                        help="key type: 'r' for RSA, 's' for SM2, 'e' for ECDSA (default: e)")
