...
# Modified by liupenghui, print private key name and SignatureSm3WithSm2 
# 
    ...
    for iden_name in kc:
        ...
        if verbose >= 1:
            for key_name in iden:
                ...
                # added by liupenghui, print private key name
                key_name = Name.to_bytes(key_name)
                print('       Private key filename:'+sha256(key_name).digest().hex() + '.privkey')
                if verbose >= 2:
...
def print_cert(cert):
    ...
    if cert_val.signature_info:
        ...
        sig_type_dict = {
            ...
            # added by liupenghui
            SignatureType.SM3_WITH_SM2: 'SignatureSm3WithSm2',
        }
