...
# Modified by liupenghui to add export/import key/certificate safbag commands
#
...
from . import cmd_init_pib, cmd_get_childitem, cmd_get_default, cmd_set_default, \
    ...
    cmd_get_signreq, cmd_export_key, cmd_import_key
...
Available commands:
  ...
  Export-key  (exportkey,ek)  Export a key/certificate safbag
  Import-key  (importkey,ik)  Import a key/certificate safbag from a file
...
def main():
    ...
    cmd_export_key.add_parser(subparsers)
    cmd_import_key.add_parser(subparsers)
